...
//
Функция ОбработатьСобытиеКалендаря(Организация, СобытиеКалендаря, ФормаВладелец = Неопределено) Экспорт
	...
	ИначеЕсли СтруктураСобытия.ТипЗадачи = "Декларация12" Тогда
		Возврат СформироватьДекларацию12(Организация, СтруктураСобытия.ДатаДокументаОбработкиСобытия, СобытиеКалендаря, ФормаВладелец);
...
//		Структура
//
Функция СформироватьДекларацию12(Организация, ДатаДокументаОбработкиСобытия,СобытиеКалендаря, ФормаВладелец) Экспорт
