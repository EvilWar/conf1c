...
Процедура ПодготовитьДанныеПоТорг12(СсылкаНаОбъект, СтруктураЭД, СтруктураПараметров) Экспорт
	...
	Иначе
		...
		ФИО			= ДанныеДокумента.РасшифровкаПодписиРуководителя;
		Должность	= ДанныеДокумента.ДолжностьРуководителя;
	...
	// Гл. бухгалтер
	УправлениеНебольшойФирмойЭлектронныеДокументыСервер.ЗаполнитьФИОиДолжность(СведенияПоОтпускуГруза.Бухгалтер, РеквизитыШапки.РасшифровкаПодписиГлавногоБухгалтера, "Главный бухгалтер");
	// Отпуск разрешил
	УправлениеНебольшойФирмойЭлектронныеДокументыСервер.ЗаполнитьФИОиДолжность(СведенияПоОтпускуГруза.ОтпускРазрешил, РеквизитыШапки.РасшифровкаПодписиРуководителя, РеквизитыШапки.ДолжностьРуководителя);
	// Отпуск произвел
	УправлениеНебольшойФирмойЭлектронныеДокументыСервер.ЗаполнитьФИОиДолжность(СведенияПоОтпускуГруза.ОтпускПроизвел, РеквизитыШапки.РасшифровкаПодписиКладовщика, РеквизитыШапки.ДолжностьКладовщика);
...
Процедура ПодготовитьДанныеПоТорг12Покупатель(СсылкаНаОбъект, СтруктураЭД, СтруктураПараметров) Экспорт
	...
	Иначе
		...
		Руководители = УправлениеНебольшойФирмойЭлектронныеДокументыСервер.ОтветственныеЛицаОрганизационнойЕдиницы(СтруктураЭД.Организация, СтруктураЭД.ДатаЭД);
		
		ФИО = Руководители.РасшифровкаПодписиРуководителя;
		Должность = Руководители.ДолжностьРуководителя;
...
Процедура ПодготовитьДанныеПоСчетФактуре(СсылкаНаОбъект, СтруктураЭД, СтруктураПараметров) Экспорт
	...
	Если ЭтоФизЛицо Тогда
		...
		ДанныеСвидетельстваОРегистрацииИП(СтруктураЭД.Организация, СтруктураПараметров.Подписант.СвидетельствоОРегистрацииИП);
	Иначе
		ФИО = ШапкаДокумента.РасшифровкаПодписиРуководителя;
	КонецЕсли;
