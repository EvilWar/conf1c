...
// Возвращает подпись из карточки организации
//
//
// Параметры:
//  Организация - СправочникСсылка.Организации - организация, по которой необходимо получить записи в регистре сведений 
//  НаименованиеПодписи - Строка - название реквизита
//
// Возвращаемое значение:
//   СправочникСсылка.Подписи - значение реквизита организации
//
Функция ПолучитьПодписьОрганизации(Организация, НаименованиеПодписи) Экспорт
	
	Возврат ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Организация, НаименованиеПодписи);
